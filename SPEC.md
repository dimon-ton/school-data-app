...
- Password-protected Excel download
- Check submitted schools feature
- Duplicate submission check with update option

## File Structure:
- Code.gs - Backend: doGet, include, saveFormData, getWorkbookData, verifyDownloadPassword, getSubmittedSchools
...
## Data Structure:
SchoolData sheet columns: Timestamp, School ID, School Name, Center No, District, Director Name, Director Phone, Deputy 1 Name, Deputy 1 Phone, Deputy 2 Name, Deputy 2 Phone, Total Staff, Total Male Students, Total Female Students, Grand Total Students
...
2. Download Excel button (password protected)
3. Check submitted schools button
4. School info card (school name, center no, district)
5. Administrator card (director, phone, deputy 1&2)
6. Staff card (standard positions table + add extra positions)
...
- TOTAL_SCHOOLS stored in Script Properties
...
## Validation:
Required: schoolName, centerNo, district, directorName, directorPhone
Numbers must be >= 0
Phone: 9-10 digits
